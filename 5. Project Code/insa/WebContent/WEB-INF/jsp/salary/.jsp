...
<br>
<br>
<section id="tabs" style="width:1200px; height:900px;" class="wow fadeInDown">
		<h6>지급공제항목등록</h6>
		<hr style="background-color:white; width: 1100px; height: 1px;">
		...
		<!-- 왼쪽 창 -->
		<div style="border: 1px solid gray; width: 30%; height: 750px; float: left; ">
		...
		<!-- 오른쪽 창 -->
		<div style="border: 1px solid gray; width: 70%; height: 750px; float: left">
			<!-- 큰 내용들 -->
			...
			<div style=" width: 100%; height: 100px;">
				<!-- 우선순위그리드 -->
				<div style="border: 1px solid white; width: 100%; height: 100px;">
					<div id="PRIORITY_grid" style="height: 100%; width: 50%; float: left" class="ag-theme-balham"></div>
				</div>
			</div>
			<!-- 작은 그리드 2개 -->
				<div style="border: 1px solid white; width: 50%; height: 200px; float:left">
			...
			<div style="border: 1px solid cyan; width: 100%; height: 100px; float:left">
				<div style="border: 1px solid purple; width: 12%; height: 100px; float:left">
