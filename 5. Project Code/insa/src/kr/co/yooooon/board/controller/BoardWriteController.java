...
public class BoardWriteController extends MultiActionController {
	private static BoardServiceFacade boardServiceFacade = BoardServiceFacadeImpl.getInstance();
	private ModelAndView modelAndView = null;
	PrintWriter out = null;

	public ModelAndView findBoardWrite(HttpServletRequest request, HttpServletResponse response) {
		System.out.println("@@@@@@@@@@findBoardWrite@@@@@@@@@@@@@@@@");
		...
		try {
			...
			boardServiceFacade.findBoardWrite(boardto);
