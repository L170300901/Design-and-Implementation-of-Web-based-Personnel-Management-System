...
public class ChatUnreadController extends MultiActionController {
	private static ChatSubmitServiceFacade chatServiceFacade = ChatSubmitServiceFacadeImpl.getInstance();
	private ModelAndView modelAndView = null;
	PrintWriter out = null;
	
	public ModelAndView chatUnread(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			int result=chatServiceFacade.chatUnread(userID);
