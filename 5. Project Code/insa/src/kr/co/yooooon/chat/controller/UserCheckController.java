...
public class UserCheckController extends MultiActionController {
	private static ChatSubmitServiceFacade chatServiceFacade = ChatSubmitServiceFacadeImpl.getInstance();
	private ModelAndView modelAndView = null;
	PrintWriter out = null;
	
	public ModelAndView userCheck(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			int result=chatServiceFacade.chatSubmit(userID);
